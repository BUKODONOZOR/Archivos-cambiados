import {mainNews,mainNewsItem, mainNewsText, additionalImages, otherNews, otherNewsItem   } from './styleNews.css'
            ...
            <section class="${mainNews}">
                <div class="${mainNewsItem}">
                    ...
                    <div class="${additionalImages}">
                        <img src="${publish1}" alt="Additional Image 1">
                        <img src="${publish2}" alt="Additional Image 2">
                        <img src="${publish3}" alt="Additional Image 3">
                        <img src="${publish4}" alt="Additional Image 4">
                    </div>
                </div>
            </section>
